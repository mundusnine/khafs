 ...
 */
import { Endpoint, EventSource, PostMessageWithOrigin } from "./protocol.js";
export { Endpoint };
...
declare type Promisify<T> = T extends {
    [proxyMarker]: boolean;
} ? Promise<Remote<T>> : T extends Promise<any> ? T : T extends (...args: infer R1) => infer R2 ? (...args: R1) => Promisify<R2> : Promise<T>;
export declare type Remote<T> = (T extends (...args: infer R1) => infer R2 ? (...args: R1) => Promisify<R2> : {
...
export declare function wrap<T>(ep: Endpoint): Remote<T>;
export declare function transfer(obj: any, transfers: Transferable[]): any;
export declare function proxy<T>(obj: T): T & {
    [proxyMarker]: true;
};
export declare function windowEndpoint(w: PostMessageWithOrigin, context?: EventSource): Endpoint;
